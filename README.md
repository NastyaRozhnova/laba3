...
2. В настройках сети виртуальных машин выбираем пункт ```Сеть NAT``` и подключаем каждую машину к ней. Первая виртаульная машина должна быть подключена к двум сетям одновременно, чтобы иметь доступ и ко второй, и к третьей одновременно. Вторую и третью машину подключаем только к одной сети.
